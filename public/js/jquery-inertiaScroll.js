...
(function ($) {
  $.fn.inertiaScroll = function (options) {
    ...
    var ChildBox = function ChildBox(elm, offset, speed, margin) {
      this.elm = elm;
    ...
    var ParentBox = function ParentBox(elm, offset, speed, margin) {
    ...
    Boxes.prototype = {
      ...
      createElm: function createElm(child, parent) {
